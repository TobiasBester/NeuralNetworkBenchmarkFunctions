...
from nn_util.model_builder import build_model
from nn_util.model_fitter import fit_model, evaluate_model, save_results_to_file
...
from data_util.data_splitter import split_data
...
def main():
    ...
    print('2. Obtaining training data')
    ...
    dataset_group = split_data(dataset, benchmark_func=nn_params.function_definition, inspect_data=verbose)
    ...
    save_results_to_file(nn_params, train_history, test_mse)
